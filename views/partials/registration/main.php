                ...
                <div class="form__text-inputs">
                    <div class="registration__input-wrapper form__input-wrapper">
                        ...
                        <div class="form__input-section <?= isset($errors['email']) ? "form__input-section--error" : '' ?>">
                            <input class="registration__input form__input" id="registration-email" type="email" name="email" value="<?= get_post_val('email'); ?>" placeholder="Укажите эл.почту">
                    ...
                    <div class="registration__input-wrapper form__input-wrapper">
                        ...
                        <div class="form__input-section <?= isset($errors['login']) ? "form__input-section--error" : '' ?>">
                            <input class="registration__input form__input" id="registration-login" type="text" name="login" value="<?= get_post_val('login'); ?>" placeholder="Укажите логин">
                            <button class="form__error-button button" type="button">!<span class="visually-hidden">Информация об ошибке</span></button>
                            <div class="form__error-text">
                                <h3 class="form__error-title">Заголовок сообщения</h3>
                    ...
                    <div class="registration__input-wrapper form__input-wrapper">
                        ...
                        <div class="form__input-section <?= isset($errors['password']) ? "form__input-section--error" : '' ?>">
                            <input class="registration__input form__input" id="registration-password" type="password" name="password" value="<?= get_post_val('password'); ?>" placeholder="Придумайте пароль">
                            <button class="form__error-button button" type="button">!<span class="visually-hidden">Информация об ошибке</span></button>
                            <div class="form__error-text">
                                <h3 class="form__error-title">Заголовок сообщения</h3>
                    ...
                    <div class="registration__input-wrapper form__input-wrapper">
                        ...
                        <div class="form__input-section <?= isset($errors['password-repeat']) ? "form__input-section--error" : '' ?>">
                            <input class="registration__input form__input" id="registration-password-repeat" type="password" name="password-repeat" value="<?= get_post_val('password-repeat'); ?>" placeholder="Повторите пароль">
                            <button class="form__error-button button" type="button">!<span class="visually-hidden">Информация об ошибке</span></button>
                            <div class="form__error-text">
                                <h3 class="form__error-title">Заголовок сообщения</h3>
                                <p class="form__error-desc"><?= $errors['password'] ?? '' ?></p>
            ...
            <div class="adding-post__input-file-container form__input-container form__input-container--file">
                <div class="adding-post__input-file-wrapper form__input-file-wrapper">
                    <div class="adding-post__file-zone adding-post__file-zone--photo form__file-zone dropzone">
                        <input class="adding-post__input-file form__input-file" id="userpic-file" type="file" name="userpic-file" title=" ">
